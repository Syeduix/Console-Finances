...
for (var i = 1; i < finances.length; i++) {
  ...
  var currentAmount = currentMonth[1];
  var previousAmount = previousMonth[1];
...
console.log("Date of greatest increase: " + greatestIncreaseDate);
...
console.log("Date of greatest decrease: " + greatestDecreaseDate);
